...
export default function AssociationHomeClothe({ route }) {
  ...
  const handlePostRequest = async () => {
    if (!description.trim()) {
      Alert.alert("Note", "Please write the description first.");
      return;
    }
    ...
    try {
      const response = await fetch(
        `${SERVER_URL}/assoc/request-donation`,
        {
          method: 'POST',
  ...
  const handleCloseForm = () => {
    setDescription(''); // إعادة تعيين النص
    setIsFormVisible(false);
  };
            ...
            {!isFormVisible ? (
              <>
                ...
                <View style={styles.cardShadowWrapper}>
                  <TouchableOpacity 
                    ...
                    onPress={() => navigation.navigate("DashboardAssociationClothes", route.params)}
                  >
                    <View style={styles.imageBox}>
                      <Image
                        source={require('../assets/images/requestcloth.png')} 
                        style={styles.fullImg}
                        resizeMode="cover"
                      />
                    </View>
                    <View style={styles.cardFooter}>
                      <Text style={styles.cardTitle}>Clothes Donation</Text>
              ...
              <View style={styles.formCard}>
                ...
                <TextInput 
                  ...
                  placeholder="Example: We need 50 winter coats..."
